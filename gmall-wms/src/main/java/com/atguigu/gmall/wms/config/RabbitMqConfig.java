...
public class RabbitMqConfig {
    ...
    public Queue ttlQueue(){
        ...
        return new Queue("TTL-WMS-QUEUE", true, false, false, arguments);
    }
    ...
    public Binding ttlBinding(){
        ...
        return new Binding("TTL-WMS-QUEUE", Binding.DestinationType.QUEUE, "ORDER-CART-EXCHANGE", "wms.ttl", null);
    }
