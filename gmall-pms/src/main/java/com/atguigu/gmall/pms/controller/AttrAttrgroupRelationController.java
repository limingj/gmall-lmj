...
public class AttrAttrgroupRelationController {
    ...
    public Resp<String> deleteAttr(@RequestBody List<AttrAttrgroupRelationEntity> relationEntitys){
        this.attrAttrgroupRelationService.deleteAttr(relationEntitys);
        return Resp.ok("删除成功");
    }
